...
<header>
	...
	<div class="row justify-content-between cadre-navbar bg-dark">
		<div class="col-xl-6 col-lg-5 col-5 pl-0">
		...
		<div class="col-xl-6 col-lg-7 col-7 pr-0">
			<div
				class="row justify-content-end bouton-navbar bg-dark text-right">
				<c:choose>
					...
					<span class="col-lg-auto col-12 text-center">Bienvenue <c:out value="${sessionUtilisateur.nom }"></c:out></span>
						...
						<a class="col-lg-3 col-sm-7 col-9  mb-1 btn btn-info"
								...
								Compte</a> <a class="col-lg-4 col-sm-7 col-9  mb-1 btn btn-info"
